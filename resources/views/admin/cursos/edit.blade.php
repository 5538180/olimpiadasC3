                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('cursos.update', ['curso' => $curso]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="edicion_id" id="edicion_id" value="{{ old('edicion_id') ?? $curso->edicion_id }}" class="w-full border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
                            <label for="enlace_curso_modle" class="block text-gray-700">Enlace Curso Módulo</label>
                            <input type="text" name="enlace_curso_modle" id="enlace_curso_modle" value="{{ old('enlace_curso_modle') ?? $curso->enlace_curso_modle }}" class="w-full border-gray-300 rounded-md">
                        </div>
